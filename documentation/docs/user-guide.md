...
If you update the application (for example, add persistence or new endpoints), update the documentation in the `documentation` folder and optionally add documentation on tests or examples.
